            ...
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                ...
                <c:forEach items="${o.orderitems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR" >
                        <td class="orderItemProductInfoPartTD"><img width="80" height="80" src="img/scenicSpot/${oi.scenic_spot.firstScenicSpotImage.id}.jpg"></td>
                        <td class="orderItemProductInfoPartTD">
                            <div class="orderListItemProductLinkOutDiv">
                                <a href="foreScenicSpot?sid=${oi.scenic_spot.id}">${oi.scenic_spot.sname}</a>
                        ...
                        <td  class="orderItemProductInfoPartTD" width="100px">
                            ...
                            <div class="orderListItemProductOriginalPrice">￥<fmt:formatNumber type="number" value="${oi.scenic_spot.price}" minFractionDigits="2"/></div>
                            <div class="orderListItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.scenic_spot.price}" minFractionDigits="2"/></div>
